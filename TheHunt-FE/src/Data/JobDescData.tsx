...
const card=[
    {name:"Location", icon:FaMapMarkerAlt, value:"New York", id : "location"},
    {name:"Experience", icon:FaBriefcase, value:"Expert", id : "experience"},
    {name:"Salary", icon:TbPremiumRights, value:"48 LPA", id : "packageOffered"},
    {name:"Job Type", icon:FaBolt, value:"Full Time", id : "jobType"},
]
