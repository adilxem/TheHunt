import { FaAngleLeft, FaGhost } from "react-icons/fa";
...
const SignUpPage = () => {
	...
	return (
		...
		<div className="min-h-[90vh] bg-congress-blue-950 font-['poppins'] overflow-hidden relative">

			<Button className="!absolute left-5 z-10" leftSection={<FaAngleLeft size={20} />} my="md" onClick={() => navigate("/")} color="bright-sun.4" variant="light" >Home</Button>
